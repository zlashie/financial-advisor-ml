...
export interface Investments {
  equity_value: number; property_value: number;
  property_growth_rate: number; equity_return_rate: number;
}
export interface RecommendationRequest {
  debts: Debt[]; investments: Investments;
  horizon_years: number; monthly_extra: number;
}
